        ...
        <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
            <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
                ...
                <motion.div className="md:w-3/5" initial="hidden" whileInView="visible"
                    ...
                    <p className="my-5">Embark on your fitness journey today and join us to sculpt a healthier,
                        stronger version of yourself. Our comprehensive programs cater to all fitness levels, offering a
                        supportive community, expert guidance, and a personalized approach to help you achieve your
                        wellness goals. </p>
                </motion.div>
                ...
                <div className="mt-10 justify-between gap-8 md:flex">
                    <motion.div className="mt-10 basis-3/5 md:mt-0" initial="hidden" whileInView="visible"
                        ...
                        <form target="_blank" onSubmit={onSubmit} method="POST"
                              action="https://formsubmit.co/rishabpal2000@gmail.com">
                            ...
                            <input type="text" className={inputStyle}
                                   placeholder="EMAIL" {...register("email", {required: true, pattern: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i})}/>
                            {errors.email && (
                                <p className="mt-1 text-primary-500">
                            ...
                            <textarea className={inputStyle} rows={4} cols={50}
                                   placeholder="MESSAGE" {...register("message", {required: true, maxLength: 2000})}/>
                            {errors.message && (
                                <p className="mt-1 text-primary-500">
                    ...
                    <motion.div className="relative mt-16 basis-2/5 md:mt-0" initial="hidden" whileInView="visible"
                                viewport={{once: true, amount: 0.5}}
